  ...
  return (
    <>
      ...
      >
        {/* Fixed left column */}
        <div
          className="sticky left-0 z-[5] flex min-w-[280px] w-[280px] shrink-0 flex-col justify-center gap-0.5 border-r border-[var(--border)] bg-[#fafafa] dark:bg-[#0f0f0f] px-4 py-3 cursor-pointer"
